...
* `xref:./14_retrospektive.adoc[Zur Vollständigen Dokumentation]`
...
* Lob & Positives:
  ** Klar formulierte Frontend-Tickets
  ** Schnelle und aktive Kommunikation im Team
  ** Erste Erfolge durch verbesserte Ticket- und Review-Prozesse

== 15. Meeting, 25.06.2025:

* `xref:./15_meeting.adoc[Zur Vollständigen Dokumentation]`
* alle Autoren bei allgemeinen und Modellierungs-Dokumenten ergänzen
...
* Präsentation: Main-Branch stabil bis Samstagmittag